...
/** Cliente com a identidade verificada do chamador — RLS roda como o usuário. */
...
/** Ambiente de produção (o Modo Teste fica fora das ferramentas MCP). */
export const PROD_ENV = "producao";