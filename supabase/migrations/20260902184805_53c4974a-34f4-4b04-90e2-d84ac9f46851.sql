DROP FUNCTION public.save_mgmv_agreement_atomic(uuid, jsonb, jsonb);

CREATE FUNCTION public.save_mgmv_agreement_atomic(
  _client_id uuid,
  _agreement jsonb,
  _installments jsonb,
  _client_mgmv jsonb
...
REVOKE ALL ON FUNCTION public.save_mgmv_agreement_atomic(uuid,jsonb,jsonb,jsonb) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.save_mgmv_agreement_atomic(uuid,jsonb,jsonb,jsonb) FROM anon;
GRANT EXECUTE ON FUNCTION public.save_mgmv_agreement_atomic(uuid,jsonb,jsonb,jsonb) TO authenticated;
GRANT EXECUTE ON FUNCTION public.save_mgmv_agreement_atomic(uuid,jsonb,jsonb,jsonb) TO service_role;